...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $users = [
            [
                'name' => 'Master Master',
                'username' => md5(md5(md5('chisae'))),
                'password' => md5(md5(md5('chisae'))),
            ...
            [
                ...
                'auth_token' => md5(md5(md5(md5(md5(md5('chisae123'))) . md5(md5(md5('chisae123')))))),
                // 'level' => 'Admin',
                'created_by' => 1,
                'updated_by' => 1,
                'created_at' => Carbon\Carbon::now()->toDateTimeString(),
            ...
            [
                'name' => 'Tester Tester 2',
                'username' => md5(md5(md5('chisae456'))),
                'password' => md5(md5(md5('chisae456'))),
                'auth_token' => md5(md5(md5(md5(md5(md5('chisae456'))) . md5(md5(md5('chisae456')))))),
                // 'level' => 'Admin',
                'created_by' => 1,
                'updated_by' => 1,
                'created_at' => Carbon\Carbon::now()->toDateTimeString(),
